...
import sub_mod.obj_block.tile_entity.TileEntityObj19;

public class RenderTileEntityObj19 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj19)tile, x, y, z, f);
	}

	private void render(TileEntityObj19 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
