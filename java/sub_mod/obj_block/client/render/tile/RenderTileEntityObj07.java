...
import sub_mod.obj_block.tile_entity.TileEntityObj07;

public class RenderTileEntityObj07 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj07)tile, x, y, z, f);
	}

	private void render(TileEntityObj07 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
