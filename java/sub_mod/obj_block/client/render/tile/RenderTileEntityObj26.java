...
public class RenderTileEntityObj26 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj26)tile, x, y, z, f);
	}

	private void render(TileEntityObj26 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
