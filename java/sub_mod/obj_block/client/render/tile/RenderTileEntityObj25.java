...
import sub_mod.obj_block.tile_entity.TileEntityObj25;

public class RenderTileEntityObj25 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj25)tile, x, y, z, f);
	}

	private void render(TileEntityObj25 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
