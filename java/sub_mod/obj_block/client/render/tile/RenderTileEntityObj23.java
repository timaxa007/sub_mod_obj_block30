...
import sub_mod.obj_block.tile_entity.TileEntityObj23;

public class RenderTileEntityObj23 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj23)tile, x, y, z, f);
	}

	private void render(TileEntityObj23 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
