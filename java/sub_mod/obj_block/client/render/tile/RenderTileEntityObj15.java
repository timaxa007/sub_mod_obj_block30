...
import sub_mod.obj_block.tile_entity.TileEntityObj15;

public class RenderTileEntityObj15 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj15)tile, x, y, z, f);
	}

	private void render(TileEntityObj15 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
