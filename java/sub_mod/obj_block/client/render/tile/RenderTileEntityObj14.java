...
import sub_mod.obj_block.tile_entity.TileEntityObj14;

public class RenderTileEntityObj14 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj14)tile, x, y, z, f);
	}

	private void render(TileEntityObj14 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
