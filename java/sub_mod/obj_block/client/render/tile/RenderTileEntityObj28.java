...
import sub_mod.obj_block.tile_entity.TileEntityObj28;

public class RenderTileEntityObj28 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj28)tile, x, y, z, f);
	}

	private void render(TileEntityObj28 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
