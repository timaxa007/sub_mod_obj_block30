...
public class RenderTileEntityObj30 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj30)tile, x, y, z, f);
	}

	private void render(TileEntityObj30 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
