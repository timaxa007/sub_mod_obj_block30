...
import sub_mod.obj_block.tile_entity.TileEntityObj20;

public class RenderTileEntityObj20 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj20)tile, x, y, z, f);
	}

	private void render(TileEntityObj20 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
