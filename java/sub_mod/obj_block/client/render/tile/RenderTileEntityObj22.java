...
public class RenderTileEntityObj22 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj22)tile, x, y, z, f);
	}

	private void render(TileEntityObj22 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
