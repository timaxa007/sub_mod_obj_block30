...
import sub_mod.obj_block.tile_entity.TileEntityObj18;

public class RenderTileEntityObj18 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj18)tile, x, y, z, f);
	}

	private void render(TileEntityObj18 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
