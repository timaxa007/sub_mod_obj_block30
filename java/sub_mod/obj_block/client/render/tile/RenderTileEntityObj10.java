...
import sub_mod.obj_block.tile_entity.TileEntityObj10;

public class RenderTileEntityObj10 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj10)tile, x, y, z, f);
	}

	private void render(TileEntityObj10 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
