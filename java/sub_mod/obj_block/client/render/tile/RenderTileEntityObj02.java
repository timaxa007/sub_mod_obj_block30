...
import sub_mod.obj_block.tile_entity.TileEntityObj02;

public class RenderTileEntityObj02 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj02)tile, x, y, z, f);
	}

	private void render(TileEntityObj02 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
