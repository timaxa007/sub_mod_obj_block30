...
import sub_mod.obj_block.tile_entity.TileEntityObj24;

public class RenderTileEntityObj24 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj24)tile, x, y, z, f);
	}

	private void render(TileEntityObj24 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
