...
import sub_mod.obj_block.tile_entity.TileEntityObj29;

public class RenderTileEntityObj29 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj29)tile, x, y, z, f);
	}

	private void render(TileEntityObj29 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
