...
public class RenderTileEntityObj17 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj17)tile, x, y, z, f);
	}

	private void render(TileEntityObj17 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
