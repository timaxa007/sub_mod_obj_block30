...
import sub_mod.obj_block.tile_entity.TileEntityObj04;

public class RenderTileEntityObj04 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj04)tile, x, y, z, f);
	}

	private void render(TileEntityObj04 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
