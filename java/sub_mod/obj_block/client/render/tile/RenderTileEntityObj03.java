...
import sub_mod.obj_block.tile_entity.TileEntityObj03;

public class RenderTileEntityObj03 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj03)tile, x, y, z, f);
	}

	private void render(TileEntityObj03 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
