...
import sub_mod.obj_block.tile_entity.TileEntityObj06;

public class RenderTileEntityObj06 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj06)tile, x, y, z, f);
	}

	private void render(TileEntityObj06 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
