...
public class RenderTileEntityObj21 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj21)tile, x, y, z, f);
	}

	private void render(TileEntityObj21 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
