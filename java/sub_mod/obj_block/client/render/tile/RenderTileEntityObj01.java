...
import sub_mod.obj_block.tile_entity.TileEntityObj01;

public class RenderTileEntityObj01 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj01)tile, x, y, z, f);
	}

	private void render(TileEntityObj01 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
