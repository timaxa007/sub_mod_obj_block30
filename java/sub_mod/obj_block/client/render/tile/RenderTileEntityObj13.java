...
import sub_mod.obj_block.tile_entity.TileEntityObj13;

public class RenderTileEntityObj13 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj13)tile, x, y, z, f);
	}

	private void render(TileEntityObj13 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
