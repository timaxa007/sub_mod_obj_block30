...
import sub_mod.obj_block.tile_entity.TileEntityObj11;

public class RenderTileEntityObj11 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj11)tile, x, y, z, f);
	}

	private void render(TileEntityObj11 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
