...
public class RenderTileEntityObj12 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj12)tile, x, y, z, f);
	}

	private void render(TileEntityObj12 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
