...
import sub_mod.obj_block.tile_entity.TileEntityObj05;

public class RenderTileEntityObj05 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj05)tile, x, y, z, f);
	}

	private void render(TileEntityObj05 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
