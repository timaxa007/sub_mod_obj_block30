...
import sub_mod.obj_block.tile_entity.TileEntityObj27;

public class RenderTileEntityObj27 extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float f) {
		render((TileEntityObj27)tile, x, y, z, f);
	}

	private void render(TileEntityObj27 tile, double x, double y, double z, float f) {
		GL11.glPushMatrix();
